...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">abhimrj8355@gmail.com</a>
        <i class="fa fa-phone"></i> +91 8604812911
      </div>
    </div>
  </section>
  ...
  <section id="intro">
    ...
    <div id="intro-carousel" class="owl-carousel" >
      <div class="item" style="background-image: url('img/travel1.jpeg');"></div>
      <div class="item" style="background-image: url('img/travel2.jpeg');"></div>
      <div class="item" style="background-image: url('img/bus3.jpg');"></div>
      <div class="item" style="background-image: url('img/travel3.jpeg');"></div>
      <div class="item" style="background-image: url('img/travel4.jpeg');"></div>
      <div class="item" style="background-image: url('img/travel5.jpeg');"></div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="#">Abhishek Prajapati</a>
      </div>
    </div>
  </footer><!-- #footer -->
